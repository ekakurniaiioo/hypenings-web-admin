<div class="bg-gray-800 text-white w-64 min-h-screen flex-shrink-0">
	...
	<nav class="mt-6">
		...
		<a href="{{ route('article.index') }}" class="flex items-center px-6 py-3 {{ request()->routeIs('news.*') ? 'text-white bg-gray-700 border-l-4 border-blue-500' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">
			<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
